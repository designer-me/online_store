            ...
            <div class="container">
                <div class="main-heading-holder">
                    <div class="main-heading style-1">
                        <h2>Recently <span class="theme-color">Viewed</span></h2>
                    </div>
                </div>
                        ...
                        <div class="best-seller-slider">
                            <?php
                                ...
                                if($cnnt['cnnt']=="0"){
									$db->where("status","1");
                                    $db->orderby("id","asc");
                                    $pro = $db->get("skyevo_product",4);
                                    for($i=0;$i<sizeof($pro);$i++){
                            ?>
                            <a href="shop-detail/<?=$pro[$i]['id']?>/<?=$pro[$i]['pro_slug']?>">
                                <div class="item">
                                    <div class="product-box">
                                        <div class="product-img">
                                            <img src="books_image/<?=$pro[$i]['pro_image']?>" alt="<?=$pro[$i]['pro_title']?>" title="<?=$pro[$i]['pro_title']?>">
                            ...
                            <?php
                                    ...
                                    $db->where("ip_address",$ip);
                                    $rec = $db->get("skyevo_recently",4);
                                    for($i=0;$i<sizeof($rec);$i++){
										$db->where("status","1");
                                        $db->where("id",$rec[$i]['pro_id']);
                                        $pro = $db->get("skyevo_product");
                            ?>
                            <a href="shop-detail/<?=$pro[0]['id']?>/<?=$pro[0]['pro_slug']?>">
                                <div class="item">
                                    <div class="product-box">
                                        <div class="product-img">
                                            <img src="books_image/<?=$pro[0]['pro_image']?>" alt="<?=$pro[0]['pro_title']?>" title="<?=$pro[0]['pro_title']?>" style="width: 132px; height: 197px;">
                                        </div>
                                        <div class="product-detail">
                                            <h5><?=substr($pro[0]['pro_title'],0,15)?>...</h5>
                                            <p><?=substr($desc,0,26)?>...</p>
                                            <div class="rating-nd-price">
                                                <strong><i class="fa fa-inr"></i> <?=$pro[0]['pro_selling_price']?> <?=(($pro[0]['pro_actual_price'] != "")?'<span class="text-danger" style="font-size:14px;"><strike><i class="fa fa-inr"></i> '.$pro[0]['pro_actual_price'].'</strike></span>':'')?></strong>
                                                <ul class="rating-stars">
                                                    <?php
                                                    if($pro[0]['pro_rating'] == "0"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/0.png">
                                                    <?php
                                                    }else if($pro[0]['pro_rating'] == "1"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/1.png">
                                                    <?php
                                                    }else if($pro[0]['pro_rating'] == "2"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/2.png">
                                                    <?php
                                                    }else if($pro[0]['pro_rating'] == "3"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/3.png">
                                                    <?php
                                                    }else if($pro[0]['pro_rating'] == "4"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/4.png">
                                                    <?php
                                                    }else if($pro[0]['pro_rating'] == "5"){
                                                    ?>
                                                    <img src="<?=$home_url?>images/5.png">
                                                    <?php
                                                    }
