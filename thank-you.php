...
//    $txn = substr($str, 0,16);
//    $staArray = array("payment_status"=>"1","txn_id"=>"$txn","paid_on"=>"$date","order_status"=>"Pending");
//    $db->where("ship_id",$_SESSION['shipId']);
//    $upd = $db->update("skyevo_shipping",$staArray);
    ...
    $msg = 'Hi! You have successfully Placed your Order at SKYEVO ! We have Received a payment of Rs. '.$getShip[0]['total_amount'].'. Your transaction id is '.$getShip[0]['txn_id'].''; 
                        ...
                        <div class="login-form">
                            <div class="main-div">
                                <div class="panel">
                                    ...
                                    <h5 class="text-center">You have successfully Placed your Order !<br/><br/> We have Received a payment of <span style="color:blue;">Rs.<?=$getShip[0]['total_amount']?> </span>. 
                                        your transaction id is <span style="color: red;"><?=$getShip[0]['txn_id']?></span>.<br/> We Will Contact you soon.</h5>
                                    <br/>
